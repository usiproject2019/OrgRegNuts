#' Compare NUTS from a register file to the 2016 eurostat NUTS.
#'
...
#' @examples
#' ## Not Run:
#' Belgium <- Correct_Nuts_xlsm("register_be_final", "be")
#'
#'
#'  Correct_Nuts_xlsm("register_pl_final", "pl", T)
#'
#'
#'## End (Not run)
#' @export
Correct_Nuts_xlsm <- function(name_of_the_file, country, csv=F) {

  name_plus_format <- paste0(name_of_the_file, ".xlsm")
